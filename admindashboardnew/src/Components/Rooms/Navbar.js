                            ...
                            <ul className="navbar-nav nav__list justify-content-center flex-grow-1 pe-3">
                                {/* <li className="nav-item active">
                                    <Link
                                        ...
                                        smooth={true}
                                        offset={-100}
                                        duration={500} onClick={() => navigate('/')} className="nav-link mx-lg-2" aria-current="page">HOME</Link>
                                </li> */}
                                <li className="nav-item">
                                    <Link activeClass="active"
                                        ...
                                        spy={true}
                                        smooth={true}
                                        offset={-100} duration={500} onClick={() => navigate('/hotels')} className="nav-link mx-lg-2" >HOTELS</Link>
                                </li>
                                <li className="nav-item">
                                    <Link activeClass="active"
                                        to="contact"
                                        spy={true}
                                        smooth={true}
                                        offset={-100} duration={500}  onClick={handleSearchClick}  className="nav-link mx-lg-2" >Go Back to SEARCH</Link>
                                </li>
                            </ul>
                            {/* Close button */}
