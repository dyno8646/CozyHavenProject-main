    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddCors(options =>
            {
                ...
                {
                    opts.WithOrigins("http://localhost:3000").AllowAnyMethod().AllowAnyHeader().AllowAnyOrigin();
                });
            });
            ...
            builder.Services.AddScoped<IRepository<int, Destination>, DestinationRepository>();
